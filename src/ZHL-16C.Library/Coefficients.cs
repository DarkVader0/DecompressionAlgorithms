...
namespace DecoAlgorithm.Zhl16C;

/// <summary>
/// Bühlmann ZHL-16C tissue compartment coefficients.
/// All values sourced from Subsurface core/deco.cpp
/// </summary>
public static class Zhl16CCoefficients
{
    /// <summary>
    ...
    /// </summary>
    public static readonly double[] N2_A =
    {
    ...
    /// Used in M-value calculation: M = a + P_amb / b
    /// </summary>
    public static readonly double[] N2_B =
    {
    ...
    /// </summary>
    public static readonly double[] N2_HalfLife =
    {
        5.0,   8.0,   12.5,  18.5,
        27.0,  38.3,  54.3,  77.0,
    ...
    /// </summary>
    public static readonly double[] He_A =
    {
    ...
    /// </summary>
    public static readonly double[] He_B =
    {
    ...
    /// </summary>
    public static readonly double[] He_HalfLife =
    {
        1.88,   3.02,   4.72,   6.99,
    ...
    /// </summary>
    public static readonly double[] N2_FactorOneSecond =
    {
    ...
    /// </summary>
    public static readonly double[] He_FactorOneSecond =
    {
